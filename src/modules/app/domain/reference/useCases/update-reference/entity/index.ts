...
export class ValidateToUpdateReference {
  ...
  public idOrError!: ValidateResponse<ValidateUUID>;
  public nameOrError!: ValidateResponse<ValidateString>;
  public abbreviationOrError!: ValidateResponse<ValidateString>;
